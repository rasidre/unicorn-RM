...
/* 
 - set closed_date and closed_reason as optional props
   because not every new question has a solutions and had been closed yet
*/
...
export class SearchService {
  ...
  search(keyword: string): Observable<JSON> {
    return this.http
      .get(SearchService.apiUrl + keyword)
      .map((res: Response) => {
        let data = res.json();
        console.log(
          "API USAGE: " +
